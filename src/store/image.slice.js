...
const fetchImageQuestions = createAsyncThunk("Image/FetchImageQuestions", async (page) => {
...
const imageSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(fetchImageQuestions.fulfilled, (state, action) => {
            ...
            state.loading = false
            state.currentQuestion = 0;
            state.isFinished = action.payload.gallery.length < action.payload.meta.pageSize
        })
